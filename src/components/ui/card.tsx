...
export const Card = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-[var(--radius)] border border-border bg-bg-panel text-text shadow-[var(--shadow)]',
        className,
      )}
      {...props}
    />
...
export const CardTitle = forwardRef<HTMLHeadingElement, HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn('font-[family-name:var(--font-display)] text-base font-semibold', className)} {...props} />
  ),
);
